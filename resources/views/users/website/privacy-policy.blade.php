                                                ...
                                                <div id="privacy">
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p>
                                                                {{$company->company_name}} Application is developed by {{$company->company_name}}, a company incorporated under the Companies Act, 1956 with its
                                                                {{$company->company_address}}. This Policy describes how {{$company->company_name}}  and its Affiliates/Entities/Subsidiaries/Associates including but not limited to {{$company->company_name}}, {{$company->company_name}}  Insurance Broking Services Private Limited, {{$company->company_name}} (collectively “{{$company->company_name}} , we, our, us” as the context may require) collect, store, use and otherwise process your Personal Information through {{$company->company_name}}  website, {{$company->company_name}}  Application, m-site, chatbot, notifications or any other medium used by {{$company->company_name}}  to provide its services to you (hereinafter referred to as the “Platform”). By downloading and using {{$company->company_name}} , visiting the {{$company->company_name}}  website, providing your information or availing our product/services, you expressly agree to be bound by this Privacy Policy (“Policy”) and the applicable service/product terms and conditions. We value the trust you place in us and respect your privacy, maintaining the highest standards for secure transactions and protection of your personal information.
                                                            </p>
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            ...
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>OTP sent to you by your bank or {{$company->company_name}}  </li>
                                                                    <li>Balance, transaction history and value, bank account details, wallet balance, investment details and transactions, service or transaction related communication, part of your card details for smooth transaction using {{$company->company_name}} or any of the services</li>
                                                                    <li>Your device details such as device identifier, internet bandwidth, mobile device model, browser plug-ins, and cookies or similar technologies that may identify your browser/{{$company->company_name}} Application and plug-ins, and time spent, IP address and location</li>
                                                                    <p>
                                                                    </p>
                                                                </ul>
                                                            </p>
                                                            <p>
                                                                Information may be collected at various stages of your usage of the {{$company->company_name}}  Platform such as:
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>visiting {{$company->company_name}}  Platform</li>



                                                                    <li>registering on {{$company->company_name}}  Platform as an “user” or “merchant” or any other relationship that may be governed by terms and conditions listed on {{$company->company_name}}  Platform</li>
                                                                    <li>transacting or attempting to transact on {{$company->company_name}}  Platform</li>
                                                                    <li>accessing links, e-mails, chat conversations, feedbacks, notifications sent or owned by {{$company->company_name}}  Platform and if you opt to participate in our occasional surveys</li>
                                                                    <li>otherwise dealing with any of the {{$company->company_name}}  Affiliates/Entities/Subsidiaries/Associates</li>
                                                                    <li>while applying for career opportunities with {{$company->company_name}}  </li>
                                                                </ul>
                                                            </p>
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>your resume, your past employment and educational qualification for background checks and verifications, through online or offline databases that are otherwise legitimately obtained in case you apply for employment opportunities with {{$company->company_name}} </li>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>
                                                                {{$company->company_name}}  may process your Personal Information for the following purposes:
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>to allow third parties to contact you for products and services availed/requested by you on {{$company->company_name}}  Platform or third-party links</li>
                                                                    ...
                                                                    <li>to identify security breaches and attacks; investigating, preventing, and taking action on illegal or suspected fraud or money laundering activities and conducting forensic audits as part of internal or external audit or investigation by {{$company->company_name}}  or government agencies located within India or outside the Indian jurisdiction</li>
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            ...
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>with the internal investigation department within {{$company->company_name}}  or agencies appointed by {{$company->company_name}}  for investigation purposes located within or outside the Indian jurisdiction</li>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>{{$company->company_name}}  is an has deployed technical and physical security measures to safeguard user’s Personal Information and Sensitive Personal Information. Specifically, in order to safeguard your Aadhaar information, we have implemented applicable security controls as given under and required by the Aadhaar Regulations. We understand that as effective as our security measures are, no security system is impenetrable. Hence, as part of our reasonable security practices, we undergo strict internal and external reviews to ensure appropriate information security encryption or controls are placed for both data in motion and data at rest within our network and servers respectively. The database is stored on servers secured behind a firewall; access to the servers is password-protected and is strictly limited.</p>
                                                            <p>Further, you are responsible for maintaining the confidentiality and security of your login id and password. Please do not share your {{$company->company_name}}  login, password, and OTP details with anybody. It shall be your responsibility to intimate us in case of any actual or suspected compromise to your Personal Information.</p>
                                                            <p>We have provided multiple levels of security to safeguard the {{$company->company_name}}  Application by login/logout option and {{$company->company_name}}  Application lock feature (“Enable Screen Lock”) that can be enabled by you. We have preventive controls implemented to ensure you use {{$company->company_name}}  Application on your device and the same login credentials cannot be used on different device without any additional authentication/OTP.</p>
                                                        </div>
                                                    </div>
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        <div class="privacy__main-content-container__main-content__text__heading">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>When you are availing products and services of service providers on {{$company->company_name}}  Platform, Personal Information may be collected by respective service providers and such Personal Information shall be governed by their privacy policy. You may refer to their privacy policy and terms of service to understand how your Personal Information will be handled by such service providers.</p>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>We process your Personal Information with consent. By using the {{$company->company_name}}  Platform or services and/or by providing your Personal Information, you consent to the processing of your Personal Information by {{$company->company_name}}  in accordance with this Privacy Policy. If you disclose to us any Personal Information relating to other people, you represent that you have the authority to do so and permit us to use the information in accordance with this Privacy Policy.</p>
                                                        </div>
                                                    </div>
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        <div class="privacy__main-content-container__main-content__text__heading">
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            ...
                                                            <p>In case you wish to delete your account or Personal Information, please use the ‘Help’ section of the {{$company->company_name}}  Platform. However, retention of your Personal Information will be subject to applicable laws.</p>
                                                            <p>For the above requests, {{$company->company_name}}  may need to request specific information from you to confirm your identity and ensure authentication. This is a security measure to ensure that Personal Information is not disclosed to any person who does not have a right to receive it or is not incorrectly modified or deleted.</p>
                                                            <p>In cases where you need any further information specific to the product/ services that you are availing, we request you to read through the Terms and Conditions specific to the product/service which is easily accessible through the {{$company->company_name}}  Platform. For seeking any further information on the same, you can write to us at the details mentioned in the ‘Contact Us’ section of this Policy.</p>
                                                        </div>
                                                    </div>
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        <div class="privacy__main-content-container__main-content__text__heading">
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>In case you have any questions, concerns, or complaints regarding the processing of your Personal Information or this Privacy Policy you may write to {{$company->company_name}} ’s Privacy Officer using this link <a href="home" target="_blank">{{$company->domain}}</a> We are committed to answer your questions within the reasonable time limit. Any delay in the resolution time shall be proactively communicated to you.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="privacy__main-content-container__main-content">
                                                <div id="privacy">
                                                    <div class="privacy__main-content-container__main-content__text">
                                                      ...
                                                      position: relative;
                                                      bottom: 9px;">31 जुलाई 2023 को अपडेट किया गया</strong>
                                                            <p>
                                                                {{$company->company_name}} ऐप्लिकेशन को {{$company->company_name}} प्राइवेट लिमिटेड ने तैयार किया है। इस कंपनी का गठन कंपनी अधिनियम, 1956 के तहत किया गया है। इसके रजिस्टर्ड ऑफ़िस का पता है -
                                                                {{$company->company_address}}
. इस पॉलिसी में यह बताया गया है कि {{$company->company_name}} और इससे जुड़ी हुई या इसके तहत काम करने वाली कंपनियां/ इसकी इकाइयां/इसके नियंत्रण वाली कंपनियां/इसकी सहयोगी कंपनियां, अपनी सेवाएं आपको उपलब्ध कराने के लिए आपकी निजी जानकारी, {{$company->company_name}} की वेबसाइट, {{$company->company_name}} ऐप्लिकेशन, मोबाइल साइट, चैटबॉट, सूचना या {{$company->company_name}} के ज़रिए इस्तेमाल किए जाने वाले किसी अन्य माध्यम (यहां इन सभी को “प्लैटफ़ॉर्म” लिखा गया है) की मदद से कैसे इकट्ठा करती हैं, उसे कैसे सेव, इस्तेमाल या प्रोसेस करती हैं। {{$company->company_name}} और इससे जुड़ी हुई या इसके तहत काम करने वाली कंपनियों/ इसकी इकाइयों/इसके नियंत्रण वाली कंपनियों/इसकी सहयोगी कंपनियों में {{$company->company_name}} प्राइवेट लिमिटेड, {{$company->company_name}} इंश्योरेंस ब्रोकिंग सर्विसेज प्राइवेट लिमिटेड, {{$company->company_name}} वेल्थ ब्रोकिंग प्राइवेट लिमिटेड, {{$company->company_name}} वेल्थ प्राइवेट लिमिटेड (इन सबको एक साथ, संदर्भ के हिसाब से “{{$company->company_name}}  , हम, हमारा/हमारी, हमें” लिखा गया है) के अलावा, और भी कंपनियां शामिल हो सकती हैं।  अगर आप {{$company->company_name}} डाउनलोड करते हैं और इसका इस्तेमाल करते हैं, {{$company->company_name}} की वेबसाइट पर जाते हैं, अपनी जानकारी उपलब्ध कराते हैं या हमारे प्रॉडक्ट/सेवाओं का लाभ लेते हैं, तो इसका मतलब है, आप यह स्वीकार करते हैं कि आप इस प्राइवेसी पॉलिसी (“पॉलिसी”) और सेवा/प्रॉडक्ट से जुड़े लागू होने वाले नियम और शर्तों का पालन करेंगे। आपने हम पर जो भरोसा किया है उसकी हम कद्र करते हैं और आपकी निजता का सम्मान करते हैं। इसलिए, हम सुरक्षित लेन-देन और आपकी निजी सूचना की सुरक्षा का सबसे ऊंचा मानक बनाए रखते हैं।
                                                            </p>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>हम उस समय आपकी निजी जानकारी इकट्ठा कर सकते हैं, जब आप हमारी सेवाओं या प्लेटफ़ार्म का इस्तेमाल करेंगे या जब हमारे बीच बातचीत होगी। हम उसी निजी जानकारी को इकट्ठा करते हैं जो काम की होती है और आपने जिन सेवाओं का अनुरोध किया है उन्हें उपलब्ध कराने के लिए बहुत ज़रूरी होती है। साथ ही, हम {{$company->company_name}} प्लेटफ़ार्म में सुधार करते रहने के लिए भी इसे इकट्ठा करते हैं।</p>
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>वह OTP जो आपके बैंक या {{$company->company_name}} की ओर से भेजा गया हो</li>
                                                                    <li>बैलेंस, लेन-देन की जानकारी और वैल्यू, बैंक खाते की जानकारी, वॉलेट बैलेंस, निवेश की जानकारी और लेन-देन, सेवा या लेन-देन से जुड़ी बातचीत, {{$company->company_name}} या इसकी किसी सेवा का इस्तेमाल करके ठीक से लेन-देन के लिए आपके कार्ड की कुछ जानकारी</li>
                                                                    <li>आपके डिवाइस की जानकारी, जैसे कि डिवाइस की पहचान वाला कोड, इंटरनेट बैंडविथ, मोबाइल डिवाइस का मॉडल, ब्राउज़र प्लग-इन, और कुकी या इसी तरह की तकनीक जिसकी मदद से आपके ब्राउज़र/{{$company->company_name}} ऐप्लिकेशन और प्लग-इन की पहचान की जा सके, और बिताए गए समय, IP पता और जगह की जानकारी</li>
                                                                </ul>
                                                            </p>
                                                            <p>
                                                                आपके ज़रिए {{$company->company_name}} प्लेटफ़ार्म का इस्तेमाल करने के अलग-अलग चरणों के दौरान सूचना इकट्ठा की जा सकती है, जैसे कि:
                                                                <ul class="lower-disc-list">
                                                                    <li>जब आप {{$company->company_name}} प्लेटफ़ार्म पर जाएंगे</li>
                                                                    <li>जब आप {{$company->company_name}} प्लेटफ़ार्म पर “यूज़र” या “मर्चेंट” या किसी ऐसे कारोबारी रिश्ते के लिए रजिस्टर करेंगे जिस पर {{$company->company_name}} प्लेटफ़ार्म पर उपलब्ध सूची में दिए गए नियम और शर्तें लागू हों</li>
                                                                    <li>जब आप {{$company->company_name}} प्लेटफ़ार्म पर कोई लेन-देन करेंगे या लेन-देन की कोशिश करेंगे</li>
                                                                    <li>जब आप {{$company->company_name}} प्लेटफ़ार्म की ओर से भेजे गए या इसके मालिकाना हक वाले लिंक, ईमेल, चैट की बातचीत, फ़ीडबैक, सूचना को एक्सेस  करेंगे या अगर आप समय-समय पर होने वाले हमारे सर्वे में भाग लेने का विकल्प चुनेंगे</li>
                                                                    <li>जब आप {{$company->company_name}} से जुड़ी हुई या इसके तहत काम करने वाली किसी कंपनी/ इसकी किसी इकाई/इसके नियंत्रण वाली किसी कंपनी/इसकी सहयोगी किसी कंपनी से कोई डील करेंगे</li>
                                                                    <li>जब आप {{$company->company_name}} के पास उपलब्ध करियर के लिए आवेदन करेंगे</li>
                                                                </ul>
                                                            </p>
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>यदि आप {{$company->company_name}} के साथ रोजगार के अवसरों के लिए आवेदन करते हैं तो ऑनलाइन या ऑफलाइन डेटाबेस के माध्यम से आपका रिज्यूमे, आपका पिछला रोजगार और बैकग्राउंड की जांच और सत्यापन के लिए शैक्षिक योग्यता वैध रूप से प्राप्त की जाती है।</li>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>
                                                                {{$company->company_name}} नीचे बताए गए मकसद के लिए आपकी निजी सूचना का इस्तेमाल कर सकता है:
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>थर्ड पार्टी को उन प्रॉडक्ट और सेवाओं के बारे में आपसे संपर्क करने की अनुमति देने के लिए जिनका या तो आपने {{$company->company_name}} प्लेटफ़ार्म या थर्ड पार्टी के लिंक पर इस्तेमाल किया है/उनके लिए अनुरोध किया है</li>
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            ...
                                                            <p>
                                                                ...
                                                                <ul class="lower-disc-list">
                                                                    ...
                                                                    <li>{{$company->company_name}} के अंदरूनी जांच विभाग या भारत के अधिकारक्षेत्र के अंदर या बाहर स्थित ऐसी एजेंसियों के साथ शेयर करने के लिए जिन्हें जांच के मकसद से {{$company->company_name}} की ओर से नियुक्त किया गया है</li>
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>हम आपकी सहमति से आपकी निजी जानकारी को प्रोसेस करते हैं। {{$company->company_name}} प्लेटफ़ार्म या सेवाओं का इस्तेमाल करके और/या अपनी निजी जानकारी उपलब्ध कराकर, आप इस बात की सहमति देते हैं कि इस प्राइवेसी पॉलिसी के मुताबकि, {{$company->company_name}} के ज़रिए आपकी निजी जानकारी को प्रोसेस किया जा सकता है। अगर आप किसी अन्य व्यक्ति से जुड़ी निजी जानकारी हमें ज़ाहिर करेंगे, तो इसका मतलब आपकी ओर से यह स्वीकार करना है कि आपको ऐसा करने का अधिकार है और आप हमें इस प्राइवेसी पॉलिसी के मुताबिक जानकारी को इस्तेमाल करने की अनुमति देते हैं।</p>
                                                        </div>
                                                    </div>
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        <div class="privacy__main-content-container__main-content__text__heading">
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            ...
                                                            <p>यदि आप अपना खाता या व्यक्तिगत जानकारी हटाना चाहते हैं, तो कृपया {{$company->company_name}} प्लेटफॉर्म के 'सहायता' अनुभाग का उपयोग करें। हालांकि, आपकी व्यक्तिगत जानकारी का प्रतिधारण लागू कानूनों के अधीन होगा।</p>
                                                            <p>उपरोक्त अनुरोधों के लिए, {{$company->company_name}} को आपकी पहचान की पुष्टि करने और प्रमाणीकरण सुनिश्चित करने के लिए आपसे विशिष्ट जानकारी का अनुरोध करने की जरुरत हो सकती है। यह सुनिश्चित करने के लिए एक सुरक्षा उपाय है कि व्यक्तिगत जानकारी को किसी ऐसे व्यक्ति के सामने प्रकट नहीं किया जाता है जिसके पास इसे प्राप्त करने का अधिकार नहीं है या गलत तरीके से बदलाव या हटाया नहीं गया है।</p>
                                                            <p>अगर, आपको उस प्रॉडक्ट/सेवाओं से जुड़ी खास जानकारी की ज़रूरत है जिसका आपका इस्तेमाल करते हैं या ऐसी जानकारी की ज़रूरत है जो हमारे ज़रिए हम आपसे अनुरोध करते हैं कि आप उस प्रॉडक्ट/सेवा से जुड़े खास नियम और शर्तों को ध्यान से पढ़ें। ये नियम और शर्तें {{$company->company_name}} प्लेटफ़ार्म का इस्तेमाल करके आसानी से एक्सेस की जा सकती हैं। अगर इस के बारे में कुछ और जानकारी चाहिए, तो आप हमें इस पॉलिसी के ‘हमसे संपर्क करें’ सेक्शन में दी गई संपर्क जानकारी का इस्तेमाल करके, हमसे संपर्क कर सकते हैं।</p>
                                                        </div>
                                                    </div>
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        <div class="privacy__main-content-container__main-content__text__heading">
                                                    ...
                                                    <div class="privacy__main-content-container__main-content__text">
                                                        ...
                                                        <div class="privacy__main-content-container__main-content__text__wrapper">
                                                            <p>अगर आपके पास आपकी निजी जानकारी को प्रोसेस किए जाने या इस प्राइवेसी पॉलिसी से जुड़ा कोई सवाल है, समस्याएं हैं, तो आप {{$company->company_name}} गोपनीयता अधिकारी को इस बारे में लिख सकते हैं। इसके लिए, आपको <a href="home" target="_blank">{{$company->domain}}</a> लिंक पर जाना होगा। हम उचित समयसीमा के अंदर आपके सवालों का जवाब देंगे। अगर इसमें ज़्यादा समय लगेगा, तो इस बारे में आपको पहले ही बता दिया जाएगा।</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
