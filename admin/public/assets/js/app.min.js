...
(function () {
	...
	var horizontalMenuSplit = 99; // keep all top menus visible; do not dump items into More
	...
	function updateHorizontalMenus() {
		...
		Array.from(menuData).forEach(function (item, index) {
			...
			if (index + 1 === menuData.length && newMenus && splitItem && splitItem.insertAdjacentHTML) {
