...
@section('title') MD & DT Sale Reports @endsection
@section('css')
<!--datatable css-->
...
@slot('title') MD & DT Sale Reports @endslot
@endcomponent
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">MD & DT Sale Reports List</h4>
                <div class="flex-shrink-0">
                </div>
            </div>
...
<script>
    ...
    function fetchAllSearch() {
        ...
        $.ajax({
            url: '{{ route('mdAndDtSaleReportsList') }}',
            method: 'post',
            data: {
                user_id,
                from_date : from_date,
