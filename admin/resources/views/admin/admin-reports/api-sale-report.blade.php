...
@section('title') API Sale Reports @endsection
@section('css')
<!--datatable css-->
...
@slot('title') API Sale Reports @endslot
@endcomponent
            ...
            <div class="card-body">
                <form action="#">
                    <div class="row gy-3">
                        ...
                        <div class="col-lg-4">
                                <div>
                                    <label class="form-label mb-0">Select Api:</label>
                                    <select class="form-select mb-0 api_id" aria-label="Default select example" name="api_id">
                                    </select>
                                </div>
                            </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">API Sale Reports List</h4>
                <div class="flex-shrink-0">
                </div>
            </div>
    ...
    function fatchApi() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('.api_id').append(option);
                $.each(res.apis, function(k,v) {
                    $('.api_id').append('<option value="' + v.id + '">' + v.api_name.toUpperCase() + '</option>');
                });
                $("#preloader").hide();
