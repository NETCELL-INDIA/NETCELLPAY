...
@section('title') User Sale Reports @endsection
@section('css')
<!--datatable css-->
...
@slot('title') User Sale Reports @endslot
@endcomponent
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">User Sale Reports List</h4>
                <div class="flex-shrink-0">
                </div>
            </div>
