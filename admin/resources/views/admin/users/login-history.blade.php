...
<style>
    ...
    .lh-map-pin:hover { color: #c92a2a; transform: translateY(-1px); }
    .lh-map-pin.is-disabled { color: #adb5bd; cursor: default; pointer-events: none; }
...
<div class="card">
    <div class="card-body py-3">
        <form method="get" action="{{ route('usersLoginHistory') }}" class="row g-3 align-items-end">
            <div class="col-md-3">
