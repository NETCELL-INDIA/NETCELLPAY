        ...
        <div class="card-body">
            <form id="ssForm">
                ...
                @if($page === 'system')
                    ...
                    <p class="text-muted mt-2 mb-0" style="font-size:.8rem">Recharge API Timeout: how long to wait for the recharge API (8–180 seconds). Use 45–60 if logs show “Operation timed out”; 180 only if the upstream API is very slow.</p>
