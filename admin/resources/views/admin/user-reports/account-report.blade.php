...
<script>
    ...
    function exportExcel() {
        ...
        $.ajax({
            ...
            url: '{{ route('accountReportsExport') }}',
            ...
            success: function(response, status, xhr) {
                const filename = from_date+'_'+to_date+'_account_reports.csv'; // You can dynamically set the filename if needed
