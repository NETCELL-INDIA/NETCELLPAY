...
@section('title') Resend Report @endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="mb-1">Resend Report</h4>
            <p class="text-muted mb-0">Pending Reportನಲ್ಲಿ Resend ಅಥವಾ Rehit ಮಾಡಿದ recharge list.</p>
        </div>
    </div>
</div>
<div class="card">
    ...
    <div class="card-body">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                <label class="form-label mb-0">Recharge ID</label>
                <input type="text" class="form-control" id="recharge_id" placeholder="Order ID">
            </div>
...
<div class="card">
    <div class="card-header bg-primary"><h6 class="mb-0 text-white">Resend list</h6></div>
    <div class="card-body">
