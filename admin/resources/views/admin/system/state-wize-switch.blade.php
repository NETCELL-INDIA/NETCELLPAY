...
@section('title') State Wize Switch @endsection
...
@slot('title')State Wize Switch @endslot
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header align-items-center d-flex">
                ...
                <h4 class="card-title mb-0 flex-grow-1">State Wize Switch List</h4>
...
<script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('stateWizeSwitchDelete') }}',
    ...
    $("#edit_details_form").submit(function (e) {
        ...
        $.ajax({
            ...
            url: '{{ route('stateWizeSwitchUpdate') }}',
