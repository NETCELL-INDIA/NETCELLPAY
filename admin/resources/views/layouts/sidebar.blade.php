                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarRechargeReports">
                        <ul class="nav nav-sm flex-column">
                            ...
                            @if(admin_can('recharge_reports.live_report'))<li class="nav-item"><a href="javascript:void(0)" class="nav-link" onclick="window.open('{{ URL::asset('admin/admin-reports/recharge-live-reports') }}','liveRechargeReport','width='+(screen.width-80)+',height='+(screen.height-120)+',left=40,top=40,resizable=yes,scrollbars=yes'); return false;">Live Recharge Report</a></li>@endif
